...
if(!class_exists('NSU_Plugin_Admin_Abstract')) {
	
	abstract class NSU_Plugin_Admin_Abstract {
      ...
      var $icon_url;
		...
		{
         add_menu_page( $this->longname, $this->shortname, $this->accesslvl, $this->hook, array(&$this,'options_page_default'), $this->icon_url );
